...
def main():
    ...
    for initial_percentage_immune in [0.0]:  # [0.0,0.5]:
        for people_per_day in [0]:
            for immune_source, min_age in [(InitialImmuneType.InitialImmuneType.HOUSEHOLDS,18)]:  # [InitialImmuneType.HOUSEHOLDS, InitialImmuneType.GENERAL_POPULATION]:  #the options are:GENERAL_POPULATION,HOUSEHOLDS
                for initial_num_infected in [0]:  # [25, 100, 250, 500]:
