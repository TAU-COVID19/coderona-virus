...
def main():
    ...
    for target_immune_percentage, immune_compliance in [(1, 1)]:  # [(0.0,1),(0.5,1)]:
        for people_per_day in [630]:
            ...
            InitialImmuneType.BY_NEIGHBORHOOD, 18), (InitialImmuneType.HOUSEHOLDS, 18), (InitialImmuneType.HOUSEHOLDS_ALL_AT_ONCE, 18)]:  # the options are:GENERAL_POPULATION,HOUSEHOLDS
